...
Section:NewTextBox("Intro Text (Doors Only!)", "Remakes The Intro Of The Hotel", function(txt)
clone = game:GetService("Players").LocalPlayer.PlayerGui.MainUI.MainFrame.Intro:Clone()
clone.Name = "LiveIntro"
clone.Visible = true
clone.Parent = game:GetService("Players").LocalPlayer.PlayerGui.MainUI.MainFrame
clone.Parent.Visible = true
clone.Text = txt
game.TweenService:Create(clone,TweenInfo.new(2),{TextTransparency = 0}):Play()
game.TweenService:Create(clone.Underline,TweenInfo.new(0.5),{Size = UDim2.new(0.8,0,0.1,1)}):Play()
wait(1.5)
game.TweenService:Create(clone,TweenInfo.new(2),{TextTransparency = 1}):Play()
game.TweenService:Create(clone.Underline,TweenInfo.new(0.5),{Size = UDim2.new(0,0,0.1,1)}):Play()
wait(3)
clone:Destroy()
end)
Section:NewTextBox("Objective Text (Doors Only!)", "Remakes The Objective Of The Hotel", function(txt)
clone = game:GetService("Players").LocalPlayer.PlayerGui.MainUI.MainFrame.Objective:Clone()
clone.Name = "LiveObjective"
clone.Visible = true
clone.Parent = game:GetService("Players").LocalPlayer.PlayerGui.MainUI.MainFrame
clone.Parent.Visible = true
clone.Intro.Text = txt
clone.Intro.Visible = true
clone.Underline.Visible = true
clone.Intro.TextTransparency = 1
game.TweenService:Create(clone,TweenInfo.new(2),{TextTransparency = 0}):Play()
game.TweenService:Create(clone.Intro,TweenInfo.new(2),{TextTransparency = 0}):Play()
game.TweenService:Create(clone.Underline,TweenInfo.new(0.5),{Size = UDim2.new(0.8,0,0.1,1)}):Play()
wait(1.5)
game.TweenService:Create(clone.Intro,TweenInfo.new(2),{TextTransparency = 1}):Play()
game.TweenService:Create(clone,TweenInfo.new(2),{TextTransparency = 1}):Play()
game.TweenService:Create(clone.Underline,TweenInfo.new(0.5),{Size = UDim2.new(0,0,0.1,1)}):Play()
wait(3)
clone:Destroy()
...
local function main()
	...
	Properties.Init = function() -- TODO: MAKE BETTER
		...
		window:SetTitle("Properties "..ver)
...
local function main()
	...
	ScriptViewer.ViewScript = function(scr)
		...
		if not s or not source then
            source = "Can't Decompile Script Maybe Disabled Or You Had No Decompile Function"
		end
	...
	ScriptViewer.Init = function()
		window = Lib.Window.new()
		window:SetTitle("Script Viewer "..ver)
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Dex "..ver,TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by Moon Helped By "..ver.." Creator",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
			{12,"UIGradient",{Parent={11},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text=ver,TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "X" or "Dex "..ver
	...
	Main.CreateMainGui = function()
		local gui = create({
			...
			{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="AppName",Parent={18},Position=UDim2.new(0,2,0,38),Size=UDim2.new(1,-4,1,-40),Text="Explorer "..ver,TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,TextTruncate=1,TextWrapped=true,TextYAlignment=0,}},
		...
		-- Create Main Apps
		Main.CreateApp({Name = "Explorer "..ver, IconMap = Main.LargeIcons, Icon = "Explorer", Open = true, Window = Explorer.Window})
		
		Main.CreateApp({Name = "Properties "..ver, IconMap = Main.LargeIcons, Icon = "Properties", Open = true, Window = Properties.Window})
		
		Main.CreateApp({Name = "Script Viewer "..ver, IconMap = Main.LargeIcons, Icon = "Script_Viewer", Window = ScriptViewer.Window})
